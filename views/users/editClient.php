    ...
    <form action="">
        <div class="flex gap-3 justify-between mb-4">
            <div class="flex flex-col w-2/4">
                ...
                <input class="px-3 py-2 border-2 border-gray-400 rounded-md mt-1" type="text" id="name2" placeholder="Enter name client">
            </div>
            <div class="flex flex-col w-2/4">
                <label class="ml-2" for="address2">Address Client <span class="text-red-600">*</span></label>
                <input class="px-3 py-2 border-2 border-gray-400 rounded-md mt-1" type="text" id="address2" placeholder="Enter address client">
            </div>
        </div>
        <div class="flex flex-col">
            <label class="ml-2" for="phone2">Number Phone <span class="text-red-600">*</span></label>
            <input class="px-3 py-2 border-2 border-gray-400 rounded-md mt-1" type="text" id="phone2" placeholder="Enter phone client">
        </div>
