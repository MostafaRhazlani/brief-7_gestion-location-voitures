<div class="showAlert absolute z-10 w-1/4 bg-white p-5 top-20 hidden rounded-md text-center">
    ...
    <h1 class="text-2xl font-semibold text-center mb-10">Client added succesfuly</h1>
</div>